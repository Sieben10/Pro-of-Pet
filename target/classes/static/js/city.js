...
china['北京']=new Array('北京市');
china['上海']=new Array('上海市');
china['天津']=new Array('天津市');
china['重庆']=new Array('重庆市');
...
function chinaChange0(province, city0) {
    var pv, cv;
    var i, ii;
    pv = province.value;
    cv = city.value;
    ...
    city0.options[ii] = new Option();
    city0.options[ii].text = china[pv][i];
    city0.options[ii].value = china[pv][i];
    }
    city0.options[0].text = "请选择市区";
